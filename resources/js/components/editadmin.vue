<template>
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <h2>Modifier <small>un admin</small></h2>
        ...
        <div class="x_content">
          ...
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="item form-group">
              ...
              <center>Laissez le champ "Mot de passe" vide si vous ne voulez pas le changer</center>
...
export default {
    ...
    methods: {
      async getadminbyid(adminId){
        axios.get(`/api/admin/${this.adminId}/edit`).then(response=>{
    ...
    update(){
        axios.put(`/api/admin/${this.adminId}`, this.formData).then((response) => {
